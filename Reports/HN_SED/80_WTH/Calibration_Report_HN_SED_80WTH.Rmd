---
title: 'Manuscript Report: Low N Sedimentary Site 80_WTH'
...
source("~/Project_Master/Test_Rep/Code/HN_SED/80_WTH/TreeNut_HN_SED_Mutator.R")
...
#umol/L
Cal_Pretable_Parent<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/80_WTH/Edited Data/Soil_Solution_All2.csv", header=TRUE)
...
Cal_Pretable_W<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/80_WTH/Edited Data/Weathering_All.csv", header=TRUE)
Cal_Pretable_W$Date<-as.Date(Cal_Pretable_W$Date)

Litter_Pretable<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/80_WTH/Edited Data/Litter_Pool.csv", header=TRUE)
Litter_Pretable$Date<-as.Date(as.character(Litter_Pretable$Date))

Tree_Nut_All<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/80_WTH/Edited Data/Tree_Nut_All.csv", header=TRUE)


Litter_Fall<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/80_WTH/Edited Data/Litter_Fall.csv", header=TRUE)
Litter_Fall$Date<-as.Date(Litter_Fall$Date)

Analysis_1<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/80_WTH/Edited Data/Analysis_1.csv", header=TRUE)
...
AEC_All<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/80_WTH/Edited Data/AEC_All.csv", header=TRUE)

Lys_Table<-read.csv2("~/Project_Master/Test_Rep/Data/Base Sites/NutsForSEDLN/HN_SED_Lys_Table.csv")

Hydro_Table<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/80_WTH/Edited Data/Hydrology.csv", header=TRUE)
Hydro_Table$Date<-as.Date(Hydro_Table$Date)

SOM<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/80_WTH/Edited Data/SOM.csv")
...
Plant_Pool<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/80_WTH/Edited Data/Plant_Pool.csv")
