---
title: 'Manuscript Report: High N Sedimentary Site 40_BO'
...
source("~/Project_Master/Test_Rep/Code/HN_SED/40_BO/Weathering_HN_SED_Mutator.R")

source("~/Project_Master/Test_Rep/Code/HN_SED/40_BO/Soil_Soln_HN_SED_Mutator.R")

source("~/Project_Master/Test_Rep/Code/HN_SED/40_BO/Litter_Pool_Mutator.R")

source("~/Project_Master/Test_Rep/Code/HN_SED/40_BO/TreeNut_HN_SED_Mutator.R")
...
Cal_Pretable_W<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Edited Data/Weathering_All.csv", header=TRUE)
Cal_Pretable_W$Date<-as.Date(Cal_Pretable_W$Date)

Litter_Pretable<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Edited Data/Litter_Pool.csv", header=TRUE)
Litter_Pretable$Date<-as.Date(as.character(Litter_Pretable$Date))

Tree_Nut_All<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Edited Data/Tree_Nut_All.csv", header=TRUE)


Litter_Fall<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Edited Data/Litter_Fall.csv", header=TRUE)
Litter_Fall$Date<-as.Date(Litter_Fall$Date)

Analysis_1<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Edited Data/Analysis_1.csv", header=TRUE)
...
AEC_All<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Edited Data/AEC_All.csv", header=TRUE)

Lys_Table<-read.csv2("~/Project_Master/Test_Rep/Data/Base Sites/NutsForSEDLN/HN_SED_Lys_Table.csv")

Hydro_Table<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Edited Data/Hydrology.csv", header=TRUE)
Hydro_Table$Date<-as.Date(Hydro_Table$Date)

SOM<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Edited Data/SOM.csv")
SOM$Date<-as.Date(SOM$Date)

Lys_Leaching<-read.csv2("~/Project_Master/Test_Rep/Data/Base Sites/NutsForSEDLN/HN_SED_Leaching_Lys.csv")
...
What I get from this calculation is that for all nutrients except N and P, the stand is able to extract near exactly the required amount of each nutrient for groBO. For K, foliar leaching causes excessive total uptake, however the mineral pool is rich enough in K to facilitate this excess uptake. These graphs do not take into consideration that uptake can vary by 20% before groBO limitation is induced. 
