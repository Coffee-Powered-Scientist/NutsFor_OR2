---
title: 'Manuscript Report: Low N BASimentary Site 80_WTH'
...
source("~/Project_Master/Test_Rep/Code/HN_BAS/80_WTH/Soil_SoHN_HN_BAS_Mutator.R")
...
#umol/L
Cal_Pretable_Parent<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data/Soil_Solution_All2.csv", header=TRUE)
...
Cal_Pretable_W<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data/Weathering_All.csv", header=TRUE)
Cal_Pretable_W$Date<-as.Date(Cal_Pretable_W$Date)

Litter_Pretable<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data/Litter_Pool.csv", header=TRUE)
Litter_Pretable$Date<-as.Date(as.character(Litter_Pretable$Date))

Tree_Nut_All<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data/Tree_Nut_All.csv", header=TRUE)


Litter_Fall<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data/Litter_Fall.csv", header=TRUE)
Litter_Fall$Date<-as.Date(Litter_Fall$Date)

Analysis_1<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data/Analysis_1.csv", header=TRUE)
...
AEC_All<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data/AEC_All.csv", header=TRUE)

Lys_Table<-read.csv2("~/Project_Master/Test_Rep/Data/Base Sites/NutsForBASHN/HN_BAS_Lys_Table.csv")

Hydro_Table<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data/Hydrology.csv", header=TRUE)
Hydro_Table$Date<-as.Date(Hydro_Table$Date)

SOM<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data/SOM.csv")
SOM$Date<-as.Date(SOM$Date)

Lys_Leaching<-read.csv2("~/Project_Master/Test_Rep/Data/Base Sites/NutsForBASHN/HN_BAS_Leaching_Lys.csv")

Plant_Pool<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data/Plant_Pool.csv")
  ...
  kbl(caption = "Lysimeter Measured Soil Solution Concentrations of Reliable Months (2005)", col.names=Better_Names,         format="latex", booktabs=TRUE, escape=FALSE, align="c") %>% t(.) %>% kable_styling(latex_options = c("striped", "scale_down",     "hold_position")) %>% 
         kable_styling(font_size = 12) %>% 
              kable_classic(full_width = F, html_font = "Times") %>% landscape() %>%
                        footnote(alphabet=c("Average baBAS on TP annual average", "Does not distinguish between organic-Al and free Al", "Model does   not simulate Si uptake", "From Hynicka et al., 2017 (10-50cm) extrapolated to 1m")) %>% add_header_above(c(" "=1,  "$\\\\mu$mol/L"=25))
