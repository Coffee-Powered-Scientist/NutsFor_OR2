...
AEC_All<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/80_WTH/Edited Data/AEC_All.csv", header=TRUE)

Lys_Table<-read.csv2("~/Project_Master/Test_Rep/Data/Base Sites/NutsForSEDLN/LN_SED_Lys_Table.csv")

Hydro_Table<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/80_WTH/Edited Data/Hydrology.csv", header=TRUE)
Hydro_Table$Date<-as.Date(Hydro_Table$Date)

SOM<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/80_WTH/Edited Data/SOM.csv")
...
Plant_Pool<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/80_WTH/Edited Data/Plant_Pool.csv")
