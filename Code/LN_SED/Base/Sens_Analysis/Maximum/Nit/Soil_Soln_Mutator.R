...
setwd("~/Project_Master/Test_Rep/Output/Calibration/Output_LN_SED/Sens/Nit/Upper")
...
files <- list.files(path = "~/Sens_Parent/Sens_Nit/LN_SED/Base/Maximum/Output data/Soil solution", pattern = "*.csv", full.names = TRUE)
