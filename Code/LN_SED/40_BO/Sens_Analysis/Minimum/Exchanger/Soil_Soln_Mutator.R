...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_BO/Sens/Ex/Lower")
...
files <- list.files(path = "~/Sens_Parent/Sens_Exch/LN_SED/40_BO/Minimum/Output data/Soil solution", pattern = "*.csv", full.names = TRUE)
