...
Above_Flux<-read.csv2("~/NutsForSEDLN/Output data/Budgets/Above ground fluxes.csv", header=FALSE)
Bio_Flux<-read.csv2("~/NutsForSEDLN/Output data/Budgets/Biological cycle.csv",header=FALSE)
