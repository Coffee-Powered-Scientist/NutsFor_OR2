...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/80_BO/Edited Data")


Above_Flux<-read.csv2("~/NutsForSEDLN/80_BO/Output data/Budgets/Above ground fluxes.csv", header=FALSE)
Bio_Flux<-read.csv2("~/NutsForSEDLN/80_BO/Output data/Budgets/Biological cycle.csv",header=FALSE)
