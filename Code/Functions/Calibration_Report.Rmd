...
```{r, echo=FALSE, fig.cap="Figure 17: Litter Pool Carbon Content Over Simulation Period", fig.show="holf", out.width="50%"}
...
```{r, echo=FALSE, fig.cap="Figure 23: Tree Nutrient Content (kg/ha) in the Foliage", out.width="50%"}
...
```{r, echo=FALSE, fig.cap="Figure 24: Tree Nutrient Content (kg/ha) in the Bole. Exlcudes Bark", out.width="50%"}
...
```{r, echo=FALSE, fig.cap="Figure 25: Tree Nutrient Content (kg/ha) in the Bark", out.width="50%"}
...
```{r, echo=FALSE, fig.cap="Figure 26: Tree Nutrient Content (kg/ha) in all Ligneous Material", out.width="50%"}
