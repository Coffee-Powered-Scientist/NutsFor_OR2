...
Net_Removal_LNS<-Tree_Nut_LNS %>% subset(YEAR %in% c(065, 2147, 2229, 2311, 2393, 2475
)) %>% subset(Month %in% 8)
...
Net_Removal_HNS<-Tree_Nut_HNS %>% subset(YEAR %in% c(065, 2147, 2229, 2311, 2393, 2475
)) %>% subset(Month %in% 8)
...
Net_Removal_LNB<-Tree_Nut_LNB %>% subset(YEAR %in% c(065, 2147, 2229, 2311, 2393, 2475
)) %>% subset(Month %in% 8)
...
Net_Removal_HNB<-Tree_Nut_HNB %>% subset(YEAR %in% c(065, 2147, 2229, 2311, 2393, 2475
)) %>% subset(Month %in% 8)
