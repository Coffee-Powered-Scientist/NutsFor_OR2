...
G_Ca<-ggplot(subset(Cal_Melt, variable %in% c("Ca") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("Ca")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
...
G_Mg<- ggplot(subset(Cal_Melt, variable %in% c("Mg") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("Mg")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
...
G_K<-ggplot(subset(Cal_Melt, variable %in% c("K") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("K")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
...
G_Na<- ggplot(subset(Cal_Melt, variable %in% c("Na") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("Na")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
...
G_Al<-ggplot(subset(Cal_Melt, variable %in% c("Al") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("Al")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
...
G_DOC<- ggplot(subset(Cal_Melt, variable %in% c("DOC") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("DOC")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
...
G_Cl<- ggplot(subset(Cal_Melt, variable %in% c("DOC") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("Cl")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
...
G_SO4<- ggplot(subset(Cal_Melt, variable %in% c("SO4") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("SO4")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
...
G_NO3<- ggplot(subset(Cal_Melt, variable %in% c("NO3") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("NO3")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
...
G_NH4<- ggplot(subset(Cal_Melt, variable %in% c("NH4") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("NH4")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
...
G_R<- ggplot(subset(Cal_Melt, variable %in% c("R") & group_id %in% c("10")), aes(x=Date, y=value, color="Simulated"))+geom_line()+
  geom_line(subset(Df_Lys_HNSED_Conc, Species %in% c("ChargeB")), mapping=aes(x=Date, y=Concentration_Shallow, color="Observed"))+
