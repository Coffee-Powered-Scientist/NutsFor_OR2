...
source("~/Project_Master/Test_Rep/Code/HN_BAS/40_BO/Fert/Plant_Pool_Mutator.R")
source("~/Project_Master/Test_Rep/Code/LN_BAS/40_BO/Fert/Plant_Pool_Mutator.R")
source("~/Project_Master/Test_Rep/Code/HN_SED/40_BO/Fert/Plant_Pool_Mutator.R")
source("~/Project_Master/Test_Rep/Code/LN_SED/40_BO/Fert/Plant_Pool_Mutator.R")


source("~/Project_Master/Test_Rep/Code/LN_SED/40_BO/Fert/Above_Mutator.R")
source("~/Project_Master/Test_Rep/Code/LN_BAS/40_BO/Fert/Above_Mutator.R")
source("~/Project_Master/Test_Rep/Code/HN_SED/40_BO/Fert/Above_Mutator.R")
source("~/Project_Master/Test_Rep/Code/HN_BAS/40_BO/Fert/Above_Mutator.R")
...
Plant_Pool_HNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_BO/Fert Data/Plant_Pool.csv")
Plant_Pool_HNBAS_Ghost<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_BO/Fert Data/Plant_Pool_Ghost.csv")
Plant_Pool_HNBAS$ID<-"HNBAS"

Above_FluxGHOST_HNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_BO/Fert Data/Abov_Flux_Ghost.csv")
Above_Flux_HNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_BO/Fert Data/Abov_Flux.csv")
...
Plant_Pool_LNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_BO/Fert Data/Plant_Pool.csv")
Plant_Pool_LNBAS_Ghost<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_BO/Fert Data/Plant_Pool_Ghost.csv")
Plant_Pool_LNBAS$ID<-"LNBAS"

Above_FluxGHOST_LNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_BO/Fert Data/Abov_Flux_Ghost.csv")
Above_Flux_LNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_BO/Fert Data/Abov_Flux.csv")
...
Plant_Pool_HNSED<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Fert Data/Plant_Pool.csv")

Plant_Pool_HNSED_Ghost<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Fert Data/Plant_Pool_Ghost.csv")
Plant_Pool_HNSED$ID<-"HNSED"

Above_FluxGHOST_HNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Fert Data/Abov_Flux_Ghost.csv")
Above_Flux_HNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Fert Data/Abov_Flux.csv")

Plant_Pool_HNSED$Year<-as.Date(paste(Plant_Pool_HNSED$Year, 1, 1, sep = "-"))

# LN SED File Reading

Plant_Pool_LNSED<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_BO/Fert Data/Plant_Pool.csv")
Plant_Pool_LNSED_Ghost<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_BO/Fert Data/Plant_Pool_Ghost.csv")
Plant_Pool_LNSED$ID<-"LNSED"

Above_FluxGHOST_LNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_BO/Fert Data/Abov_Flux_Ghost.csv")
Above_Flux_LNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_BO/Fert Data/Abov_Flux.csv")
