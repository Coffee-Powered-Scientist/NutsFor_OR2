...
LNS<-ggplot(CEC_LNS, aes(x=Date, y=CEC_LNS$Ca/6230.915+Litter_All_LNS$Ca/6230.915, color="Ca", linetype="Ca")) + geom_line()+
  ...
  labs(x="Year", y="Change in Nutrient Pool Size")+
  theme(plot.title = element_text(hjust = 0.5), legend.key.size = unit(1.5, 'cm'),  text=element_text(family="A", size=15))+          
  scale_y_continuous(breaks=c(0, .25, .5, .75, 1, 1.25, 1.5))+
  coord_cartesian(ylim = c(0, 1.5))
...
Ca_LNB<-CEC_LNB$Ca/3364.286+Litter_All_LNB$Ca/3364.286
Ca_LNS<-CEC_LNS$Ca/6230.915+Litter_All_LNS$Ca/6230.915
Ca_HNS<-CEC_HNS$Ca/269.4037+Litter_All_HNS$Ca/269.4037
Ca_HNB<-CEC_HNB$Ca/232.34+Litter_All_HNB$Ca/232.34

Mg_LNS<-CEC_LNS$Mg/2448.663+Litter_All_LNS$Mg/2448.663
Mg_LNB<-CEC_LNB$Mg/3404.168+Litter_All_LNB$Mg/3404.168
Mg_HNS<-CEC_HNS$Mg/183.0244+Litter_All_HNS$Mg/183.0244
Mg_HNB<-CEC_HNB$Mg/267.2+Litter_All_HNB$Mg/267.2

K_HNS<-CEC_HNS$K/406.8207+Litter_All_HNS$K/406.8207
N_HNS<-SOM_HNS$N*14*10/22247.05+Litter_All_HNS$N/22247.05
P_HNS <-SOM_HNS$P*30.974*10/2214+Litter_All_HNS$P/2214
S_HNS<-SOM_HNS$S*32.065*10/1271.698+Litter_All_HNS$S/1271.698

K_LNB<-CEC_LNB$K/880.0967+Litter_All_LNB$K/880.0967
N_LNB<-SOM_LNB$N*14*10/9205.251+Litter_All_LNB$N/9205.251
P_LNB<-SOM_LNB$P*30.974*10/643.33+Litter_All_LNB$P/643.33
S_LNB<-SOM_LNB$S*32.065*10/824.22+Litter_All_LNB$S/824.22

K_HNB<-CEC_HNB$K/163.11+Litter_All_HNB$K/163.11
N_HNB<-SOM_HNB$N*14*10/16757+Litter_All_HNB$N/16757
P_HNB<-SOM_HNB$P*30.974*10/1242.458+Litter_All_HNB$P/1242.458
S_HNB<-SOM_HNB$S*32.065*10/699.88+Litter_All_HNB$S/699.88

K_LNS<-CEC_LNS$K/1325.840+Litter_All_LNS$K/1325.840
N_LNS <-SOM_LNS$N*14*10/8263+Litter_All_LNS$N/8263
P_LNS<-SOM_LNS$P*30.974*10/586.2+Litter_All_LNS$P/586.2
S_LNS<-SOM_LNS$S*32.065*10/754+Litter_All_LNS$S/754
...
LNB<-ggplot(CEC_LNB, aes(x=Date, y=CEC_LNB$Ca/3364.286+Litter_All_LNB$Ca/3364.286, color="Ca", linetype="Ca")) + geom_line()+
  ...
  geom_line(aes(y=CEC_LNB$K/880.0967+Litter_All_LNB$K/880.0967, color="K", linetype="K"))+
  geom_line(SOM_LNB, mapping=aes(y=N*14*10/9205.251+Litter_All_LNB$N/9205.251, color="N", linetype="N"))+
  geom_line(SOM_LNB, mapping=aes(y=P*30.974*10/667.97+Litter_All_LNS$P/667.97, color="P", linetype="P"))+
  geom_line(SOM_LNB, mapping=aes(y=S*32.065*10/824.22+Litter_All_LNB$S/824.22, color="S", linetype="S"))+
   scale_linetype_manual(values=c("solid", "solid", "solid", "dashed", "dashed", "dashed"), label=label_color)+
  scale_color_manual(values=c("red3", "orange", "magenta2", "blue", "green2", "grey"), label=label_color)+
  theme_classic2()+
