...
source("~/Project_Master/Test_Rep/Code/LN_SED/40_BO/Sens_Analysis/Maximum/Growth/Weathering_Mutator.R")
source("~/Project_Master/Test_Rep/Code/LN_BAS/40_BO/Sens_Analysis/Maximum/Growth/Weathering_Mutator.R")
source("~/Project_Master/Test_Rep/Code/HN_SED/40_BO/Sens_Analysis/Maximum/Growth/Weathering_Mutator.R")
source("~/Project_Master/Test_Rep/Code/HN_BAS/40_BO/Sens_Analysis/Maximum/Growth/Weathering_Mutator.R")

source("~/Project_Master/Test_Rep/Code/LN_SED/40_BO/Sens_Analysis/Minimum/Growth/Weathering_Mutator.R")
source("~/Project_Master/Test_Rep/Code/LN_BAS/40_BO/Sens_Analysis/Minimum/Growth/Weathering_Mutator.R")
source("~/Project_Master/Test_Rep/Code/HN_SED/40_BO/Sens_Analysis/Minimum/Growth/Weathering_Mutator.R")
source("~/Project_Master/Test_Rep/Code/HN_BAS/40_BO/Sens_Analysis/Minimum/Growth/Weathering_Mutator.R")
...
Mine_10_Plus_LNSED<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_BO/Sens/Growth/Upper/Weathering_All.csv")

Mine_10_Plus_HNSED<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Sens/Growth/Upper/Weathering_All.csv")

Mine_10_Plus_LNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_BO/Sens/Growth/Upper/Weathering_All.csv")

Mine_10_Plus_HNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_BO/Sens/Growth/Upper/Weathering_All.csv")
...
Mine_10_Minus_LNSED<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_BO/Sens/Growth/Lower/Weathering_All.csv")

Mine_10_Minus_HNSED<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Sens/Growth/Lower/Weathering_All.csv")

Mine_10_Minus_LNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_BO/Sens/Growth/Lower/Weathering_All.csv")

Mine_10_Minus_HNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_BO/Sens/Growth/Lower/Weathering_All.csv")
...
G_Ca_G<-ggplot(data = Y, aes(x = Site, y = value, fill=Inc, pattern = ID, width=.75)) +
  ...
  geom_hline(yintercept=0, linetype=1, color="black", size=.5)+ggtitle("Tree Growth Increment")+
  theme(plot.title = element_text(hjust = 0.5, size=14))

png("Ca_Growth.png", width=1000, height=500, res=115)
plot(G_Ca_G)
dev.off()


write.csv2(Sens_Coeff_tbl, "Sens_Tbl_Growth_Weath.csv")
write.csv2(Y, "Growth_Weath.csv")
write.csv(PerChange_Df, "GrowthWeath_Per.csv")