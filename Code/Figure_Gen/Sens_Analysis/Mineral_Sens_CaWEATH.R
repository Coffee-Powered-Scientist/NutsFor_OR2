...
Mine_10_Plus_LNSED<-read.csv2("~/Project_Master/Test_Rep/Output/Calibration/Output_LN_SED/Sens/Min/Lower/Weathering_All.csv")

Mine_10_Plus_HNSED<-read.csv2("~/Project_Master/Test_Rep/Output/Calibration/Output_HN_SED/Sens/Min/Lower/Weathering_All.csv")

Mine_10_Plus_LNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Calibration/Output_LN_BAS/Sens/Min/Lower/Weathering_All.csv")

Mine_10_Plus_HNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Calibration/Output_HN_BAS/Sens/Min/Lower/Weathering_All.csv")

LNSED_Mine_Max<-sum(Mine_10_Plus_LNSED$Ca)

HNSED_Mine_Max<-sum(Mine_10_Plus_HNSED$Ca)

LNBAS_Mine_Max<-sum(Mine_10_Plus_LNBAS$Ca)

HNBAS_Mine_Max<-sum(Mine_10_Plus_HNBAS$Ca)

# Minimum

Mine_10_Minus_LNSED<-read.csv2("~/Project_Master/Test_Rep/Output/Calibration/Output_LN_SED/Sens/Min/Lower/Weathering_All.csv")

Mine_10_Minus_HNSED<-read.csv2("~/Project_Master/Test_Rep/Output/Calibration/Output_HN_SED/Sens/Min/Lower/Weathering_All.csv")

Mine_10_Minus_LNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Calibration/Output_LN_BAS/Sens/Min/Lower/Weathering_All.csv")

Mine_10_Minus_HNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Calibration/Output_HN_BAS/Sens/Min/Lower/Weathering_All.csv")


LNSED_Mine_Min<-sum(Mine_10_Minus_LNSED$Ca)

HNSED_Mine_Min<-sum(Mine_10_Minus_HNSED$Ca)

LNBAS_Mine_Min<-sum(Mine_10_Minus_LNBAS$Ca)

HNBAS_Mine_Min<-sum(Mine_10_Minus_HNBAS$Ca)
