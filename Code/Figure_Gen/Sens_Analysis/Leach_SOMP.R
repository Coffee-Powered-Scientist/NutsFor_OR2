...
G_LSOMP<-ggplot(Y, aes(x=factor(Site), y=value, fill=ID, color=Species))+geom_col(position = "dodge", width=.75)+
  theme_bw()+
  labs(x="SOM-P % Change", y="Percent Difference from Original", fill="Increment")+
