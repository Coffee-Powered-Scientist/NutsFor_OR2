...
WTH_80_LNSED_H8_MELT<-melt(WTH_80_LNSED_H8, id.vars = c("Harvest", "Rock_Type", "N"))
WTH_80_LNSED_H9_MELT<-melt(WTH_80_LNSED_H9, id.vars = c("Harvest", "Rock_Type", "N"))
WTH_80_LNSED_H10_MELT<-melt(WTH_80_LNSED_H10, id.vars = c("Harvest", "Rock_Type", "N")) 
WTH_80_LNSED_H11_MELT<-melt(WTH_80_LNSED_H11, id.vars = c("Harvest", "Rock_Type", "N"))
...
WTH_80_LNBAS_H8_MELT<-melt(WTH_80_LNBAS_H8, id.vars = c("Harvest", "Rock_Type", "N"))
WTH_80_LNBAS_H9_MELT<-melt(WTH_80_LNBAS_H9, id.vars = c("Harvest", "Rock_Type", "N"))
WTH_80_LNBAS_H10_MELT<-melt(WTH_80_LNBAS_H10, id.vars = c("Harvest", "Rock_Type", "N")) 
WTH_80_LNBAS_H11_MELT<-melt(WTH_80_LNBAS_H11, id.vars = c("Harvest", "Rock_Type", "N"))
...
WTH_80_HNBAS_H8_MELT<-melt(WTH_80_HNBAS_H8, id.vars = c("Harvest", "Rock_Type", "N"))
WTH_80_HNBAS_H9_MELT<-melt(WTH_80_HNBAS_H9, id.vars = c("Harvest", "Rock_Type", "N"))
WTH_80_HNBAS_H10_MELT<-melt(WTH_80_HNBAS_H10, id.vars = c("Harvest", "Rock_Type", "N")) 
WTH_80_HNBAS_H11_MELT<-melt(WTH_80_HNBAS_H11, id.vars = c("Harvest", "Rock_Type", "N"))
...
WTH_80_HNSED_H8_MELT<-melt(WTH_80_HNSED_H8, id.vars = c("Harvest", "Rock_Type", "N"))
WTH_80_HNSED_H9_MELT<-melt(WTH_80_HNSED_H9, id.vars = c("Harvest", "Rock_Type", "N"))
WTH_80_HNSED_H10_MELT<-melt(WTH_80_HNSED_H10, id.vars = c("Harvest", "Rock_Type", "N")) 
WTH_80_HNSED_H11_MELT<-melt(WTH_80_HNSED_H11, id.vars = c("Harvest", "Rock_Type", "N"))


# BIND, SET, RUCK!!!!

Biomass_Master<-rbind(WTH_80_LNSED_H1_MELT, WTH_80_LNSED_H2_MELT, WTH_80_LNSED_H3_MELT, WTH_80_LNSED_H4_MELT,
                      WTH_80_LNSED_H5_MELT, WTH_80_LNSED_H6_MELT, WTH_80_LNSED_H7_MELT, WTH_80_LNSED_H8_MELT,
                      WTH_80_LNSED_H9_MELT, WTH_80_LNSED_H10_MELT, WTH_80_LNSED_H11_MELT, WTH_80_HNSED_H1_MELT, WTH_80_HNSED_H2_MELT, WTH_80_HNSED_H3_MELT, WTH_80_HNSED_H4_MELT,
                      WTH_80_HNSED_H5_MELT, WTH_80_HNSED_H6_MELT, WTH_80_HNSED_H7_MELT, WTH_80_HNSED_H8_MELT,
                      WTH_80_HNSED_H9_MELT, WTH_80_HNSED_H10_MELT,
                      WTH_80_HNSED_H11_MELT,WTH_80_HNBAS_H1_MELT, WTH_80_HNBAS_H2_MELT, WTH_80_HNBAS_H3_MELT, WTH_80_HNBAS_H4_MELT,
                      WTH_80_HNBAS_H5_MELT, WTH_80_HNBAS_H6_MELT, WTH_80_HNBAS_H7_MELT, WTH_80_HNBAS_H8_MELT,
                      WTH_80_HNBAS_H9_MELT, WTH_80_HNBAS_H10_MELT,
                      WTH_80_HNBAS_H11_MELT, WTH_80_LNBAS_H1_MELT, WTH_80_LNBAS_H2_MELT, WTH_80_LNBAS_H3_MELT, WTH_80_LNBAS_H4_MELT,
                      WTH_80_LNBAS_H5_MELT, WTH_80_LNBAS_H6_MELT, WTH_80_LNBAS_H7_MELT, WTH_80_LNBAS_H8_MELT,
                      WTH_80_LNBAS_H9_MELT, WTH_80_LNBAS_H10_MELT,
                      WTH_80_LNBAS_H11_MELT)
...
WTH_Aggregated_Biomass<-ggplot(Biomass_Master[order(Biomass_Master$variable,decreasing=T),], aes(fill=variable, y=value, x=Harvest, group=N)) + 
