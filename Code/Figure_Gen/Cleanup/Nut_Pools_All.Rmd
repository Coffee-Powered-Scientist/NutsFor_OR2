...
HNB<-ggplot(CEC_HNB, aes(x=TS, y=CEC_HNB$Ca/232.34+Litter_All_HNB$Ca/232.34, color="Ca", linetype="Ca")) + geom_line()+
  ...
  geom_line(SOM_HNB, mapping=aes(y=(N*14*10+Litter_All_HNB$N)/16669.57, color="N", linetype="N"))+
  geom_line(SOM_HNB, mapping=aes(y=P*30.974*10/938.1878+Litter_All_HNB$P/938.1878, color="P", linetype="P"))+
