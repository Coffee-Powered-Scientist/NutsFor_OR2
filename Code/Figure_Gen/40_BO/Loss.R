...
Years_R1_Back<-seq(2005, 2025, 1)

Years_R1_Post<-seq(2026, 2036, 1)
...
Leaching_LNS_Post<-Leaching_LNS %>% subset(group_id %in% 8 & YEAR %in% Years_40) %>%
...
Leaching_LNS_Background<-Leaching_LNS %>% subset(!YEAR %in% Years_40)
...
Net_Removal_LNS_R1<-Tree_Nut_LNS %>% subset(YEAR %in% c(2025)) %>% subset(Month %in% 8)  %>% mutate(Rot="Rotation 1", Loss1="Harvest", Loss2="Harvest")
...
Net_Removal_LNS_R1$Ca<-Net_Removal_LNS_R1$Ca_F*0+Net_Removal_LNS_R1$Ca_Bol*.94+Net_Removal_LNS_R1$Ca_Brh*0+Net_Removal_LNS_R1$Ca_Brk*.9

Net_Removal_LNS_R1$N<-Net_Removal_LNS_R1$N_F*0+Net_Removal_LNS_R1$N_Bol*.94+Net_Removal_LNS_R1$N_Brh*0+Net_Removal_LNS_R1$N_Brk*.9

Net_Removal_LNS_R1$K<-Net_Removal_LNS_R1$K_F*0+Net_Removal_LNS_R1$K_Bol*.94+Net_Removal_LNS_R1$K_Brh*0+Net_Removal_LNS_R1$K_Brk*.9

Net_Removal_LNS_R1$P<-Net_Removal_LNS_R1$P_F*0+Net_Removal_LNS_R1$P_Bol*.94+Net_Removal_LNS_R1$P_Brh*0+Net_Removal_LNS_R1$P_Brk*.9

Net_Removal_LNS$Ca<-Net_Removal_LNS$Ca_F*0+Net_Removal_LNS$Ca_Bol*.94+Net_Removal_LNS$Ca_Brh*0+Net_Removal_LNS$Ca_Brk*.9

Net_Removal_LNS$N<-Net_Removal_LNS$N_F*0+Net_Removal_LNS$N_Bol*.94+Net_Removal_LNS$N_Brh*0+Net_Removal_LNS$N_Brk*.9

Net_Removal_LNS$K<-Net_Removal_LNS$K_F*0+Net_Removal_LNS$K_Bol*.94+Net_Removal_LNS$K_Brh*0+Net_Removal_LNS$K_Brk*.9

Net_Removal_LNS$P<-Net_Removal_LNS$P_F*0+Net_Removal_LNS$P_Bol*.94+Net_Removal_LNS$P_Brh*0+Net_Removal_LNS$P_Brk*.9
...
Leaching_HNS_Post<-Leaching_HNS %>% subset(group_id %in% 8 & YEAR %in% Years_40) %>%
  summarise(across(Ca:Si, ~sum(.x, na.rm=TRUE)))  %>% mutate(Rot="Cumulative", Loss1="Leaching",Loss2="Post-Harvest Leaching" , N=NO3+NH4)  %>% 
  select(N, P, K, Ca, Rot, Loss1, Loss2)


Leaching_HNS_Background<-Leaching_HNS %>% subset(!YEAR %in% Years_40)
...
Net_Removal_HNS_R1<-Tree_Nut_HNS %>% subset(YEAR %in% c(2025)) %>% subset(Month %in% 8)  %>% mutate(Rot="Rotation 1", Loss1="Harvest", Loss2="Harvest")
...
Net_Removal_HNS_R1$Ca<-Net_Removal_HNS_R1$Ca_F*0+Net_Removal_HNS_R1$Ca_Bol*.94+Net_Removal_HNS_R1$Ca_Brh*0+Net_Removal_HNS_R1$Ca_Brk*.9

Net_Removal_HNS_R1$N<-Net_Removal_HNS_R1$N_F*0+Net_Removal_HNS_R1$N_Bol*.94+Net_Removal_HNS_R1$N_Brh*0+Net_Removal_HNS_R1$N_Brk*.9

Net_Removal_HNS_R1$K<-Net_Removal_HNS_R1$K_F*0+Net_Removal_HNS_R1$K_Bol*.94+Net_Removal_HNS_R1$K_Brh*0+Net_Removal_HNS_R1$K_Brk*.9

Net_Removal_HNS_R1$P<-Net_Removal_HNS_R1$P_F*0+Net_Removal_HNS_R1$P_Bol*.94+Net_Removal_HNS_R1$P_Brh*0+Net_Removal_HNS_R1$P_Brk*.9

Net_Removal_HNS$Ca<-Net_Removal_HNS$Ca_F*0+Net_Removal_HNS$Ca_Bol*.94+Net_Removal_HNS$Ca_Brh*0+Net_Removal_HNS$Ca_Brk*.9

Net_Removal_HNS$N<-Net_Removal_HNS$N_F*0+Net_Removal_HNS$N_Bol*.94+Net_Removal_HNS$N_Brh*0+Net_Removal_HNS$N_Brk*.9

Net_Removal_HNS$K<-Net_Removal_HNS$K_F*0+Net_Removal_HNS$K_Bol*.94+Net_Removal_HNS$K_Brh*0+Net_Removal_HNS$K_Brk*.9

Net_Removal_HNS$P<-Net_Removal_HNS$P_F*0+Net_Removal_HNS$P_Bol*.94+Net_Removal_HNS$P_Brh*0+Net_Removal_HNS$P_Brk*.9
...
Leaching_LNB_Post<-Leaching_LNB %>% subset(group_id %in% 8 & YEAR %in% Years_40) %>%
  summarise(across(Ca:Si, ~sum(.x, na.rm=TRUE)))  %>% mutate(Rot="Cumulative", Loss1="Leaching",Loss2="Post-Harvest Leaching" , N=NO3+NH4)  %>% 
  select(N, P, K, Ca, Rot, Loss1, Loss2)

Leaching_LNB_Background<-Leaching_LNB %>% subset(!YEAR %in% Years_40)
...
Net_Removal_LNB_R1<-Tree_Nut_LNB %>% subset(YEAR %in% c(2025)) %>% subset(Month %in% 8)  %>% mutate(Rot="Rotation 1", Loss1="Harvest", Loss2="Harvest")
...
Net_Removal_LNB_R1$Ca<-Net_Removal_LNB_R1$Ca_F*0+Net_Removal_LNB_R1$Ca_Bol*.94+Net_Removal_LNB_R1$Ca_Brh*0+Net_Removal_LNB_R1$Ca_Brk*.9

Net_Removal_LNB_R1$N<-Net_Removal_LNB_R1$N_F*0+Net_Removal_LNB_R1$N_Bol*.94+Net_Removal_LNB_R1$N_Brh*0+Net_Removal_LNB_R1$N_Brk*.9

Net_Removal_LNB_R1$K<-Net_Removal_LNB_R1$K_F*0+Net_Removal_LNB_R1$K_Bol*.94+Net_Removal_LNB_R1$K_Brh*0+Net_Removal_LNB_R1$K_Brk*.9

Net_Removal_LNB_R1$P<-Net_Removal_LNB_R1$P_F*0+Net_Removal_LNB_R1$P_Bol*.94+Net_Removal_LNB_R1$P_Brh*0+Net_Removal_LNB_R1$P_Brk*.9

Net_Removal_LNB$Ca<-Net_Removal_LNB$Ca_F*0+Net_Removal_LNB$Ca_Bol*.94+Net_Removal_LNB$Ca_Brh*0+Net_Removal_LNB$Ca_Brk*.9

Net_Removal_LNB$N<-Net_Removal_LNB$N_F*0+Net_Removal_LNB$N_Bol*.94+Net_Removal_LNB$N_Brh*0+Net_Removal_LNB$N_Brk*.9

Net_Removal_LNB$K<-Net_Removal_LNB$K_F*0+Net_Removal_LNB$K_Bol*.94+Net_Removal_LNB$K_Brh*0+Net_Removal_LNB$K_Brk*.9

Net_Removal_LNB$P<-Net_Removal_LNB$P_F*0+Net_Removal_LNB$P_Bol*.94+Net_Removal_LNB$P_Brh*0+Net_Removal_LNB$P_Brk*.9
...
Leaching_HNB_Post<-Leaching_HNB %>% subset(group_id %in% 8 & YEAR %in% Years_40) %>%
  summarise(across(Ca:Si, ~sum(.x, na.rm=TRUE)))  %>% mutate(Rot="Cumulative", Loss1="Leaching",Loss2="Post-Harvest Leaching" , N=NO3+NH4)  %>% 
  select(N, P, K, Ca, Rot, Loss1, Loss2)

Leaching_HNB_Background<-Leaching_HNB %>% subset(!YEAR %in% Years_40)
...
Net_Removal_HNB_R1<-Tree_Nut_HNB %>% subset(YEAR %in% c(2025)) %>% subset(Month %in% 8)  %>% mutate(Rot="Rotation 1", Loss1="Harvest", Loss2="Harvest")
...
Net_Removal_HNB_R1$Ca<-Net_Removal_HNB_R1$Ca_F*0+Net_Removal_HNB_R1$Ca_Bol*.94+Net_Removal_HNB_R1$Ca_Brh*0+Net_Removal_HNB_R1$Ca_Brk*.9

Net_Removal_HNB_R1$N<-Net_Removal_HNB_R1$N_F*0+Net_Removal_HNB_R1$N_Bol*.94+Net_Removal_HNB_R1$N_Brh*0+Net_Removal_HNB_R1$N_Brk*.9

Net_Removal_HNB_R1$K<-Net_Removal_HNB_R1$K_F*0+Net_Removal_HNB_R1$K_Bol*.94+Net_Removal_HNB_R1$K_Brh*0+Net_Removal_HNB_R1$K_Brk*.9

Net_Removal_HNB_R1$P<-Net_Removal_HNB_R1$P_F*0+Net_Removal_HNB_R1$P_Bol*.94+Net_Removal_HNB_R1$P_Brh*0+Net_Removal_HNB_R1$P_Brk*.9

Net_Removal_HNB$Ca<-Net_Removal_HNB$Ca_F*0+Net_Removal_HNB$Ca_Bol*.94+Net_Removal_HNB$Ca_Brh*0+Net_Removal_HNB$Ca_Brk*.9

Net_Removal_HNB$N<-Net_Removal_HNB$N_F*0+Net_Removal_HNB$N_Bol*.94+Net_Removal_HNB$N_Brh*0+Net_Removal_HNB$N_Brk*.9

Net_Removal_HNB$K<-Net_Removal_HNB$K_F*0+Net_Removal_HNB$K_Bol*.94+Net_Removal_HNB$K_Brh*0+Net_Removal_HNB$K_Brk*.9

Net_Removal_HNB$P<-Net_Removal_HNB$P_F*0+Net_Removal_HNB$P_Bol*.94+Net_Removal_HNB$P_Brh*0+Net_Removal_HNB$P_Brk*.9
