...
Bio_Cycle_LNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_WTH/Edited Data/Bio_Cycle.csv")

Abov_Flux_LNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_WTH/Edited Data/Abov_Flux.csv")
...
SOM_Min_LNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_WTH/Edited Data/SOM_Min.csv")

Litter_LNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_WTH/Edited Data/Litter_Pool.csv")
...
Bio_Cycle_HNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Edited Data/Bio_Cycle.csv")

Abov_Flux_HNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Edited Data/Abov_Flux.csv")
...
Manual_Minz<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Edited Data/Litter_Pool_Minz.csv")

SOM_Min_HNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Edited Data/SOM_Min.csv")

Litter_HNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Edited Data/Litter_Pool.csv")
...
Bio_Cycle_LNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_WTH/Edited Data/Bio_Cycle.csv")

Abov_Flux_LNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_WTH/Edited Data/Abov_Flux.csv")
...
SOM_Min_LNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_WTH/Edited Data/SOM_Min.csv")

Litter_LNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_WTH/Edited Data/Litter_Pool.csv")
...
Bio_Cycle_HNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_WTH/Edited Data/Bio_Cycle.csv")

Abov_Flux_HNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_WTH/Edited Data/Abov_Flux.csv")
...
SOM_Min_HNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_WTH/Edited Data/SOM_Min.csv")

Litter_HNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_WTH/Edited Data/Litter_Pool.csv")
...
K_HNB<-ggplot(subset(Bio_Cycle_HNB, YEAR %in% Years), aes(x=TS, y=K_UP-K_LF-Abov_Temp_HNB$K_THRU, color="Net Increment"))+geom_line()+
  ...
  geom_line(subset(Abov_Flux_HNB, YEAR %in% Years), mapping=aes(x=TS, y=K_THRU, color="Foliar Leaching"))+
  labs(y=NULL, x=NULL, color="Process")+
  scale_color_manual(values = c("red", "blue", "green4","purple","green","orange", "black"))+
  ggtitle("HN Basalt")+
  theme_classic()+
...
ggarrange(N_LNS, N_HNS, N_LNB, N_HNB, labels=c("A", "B", "C", "D"),
  ...
  annotate_figure(left = textGrob(expression("N Fluxes ( kg"~'⋅'~ha^{-1}~'⋅'~yr^{-1}~')'), rot = 90, vjust=.45, gp = gpar(cex = 1.3,fontsize=15,
                  ...
                  bottom = textGrob("Time Step (Year)", gp = gpar(cex = 1.3,fontsize=15)), top=textGrob("40 WTH")) %>% 
