...
Ca_LNS<-ggplot()+geom_col(Leaching_LNS, mapping= aes(x="Leached", y=Ca, fill="Leached"))+
  geom_col(Net_Removal_LNS, mapping=aes(x="Harvested", y=Ca_F*.99+Ca_Bol*.97+Ca_Brh*.99+Ca_Brk*.9, fill="Harvested"))+
...
Mg_LNS<-ggplot()+geom_col(Leaching_LNS, mapping= aes(x="Leached", y=Mg, fill="Leached"))+
  geom_col(Net_Removal_LNS, mapping=aes(x="Harvested", y=Mg_F*.99+Mg_Bol*.97+Mg_Brh*.99+Mg_Brk*.9, fill="Harvested"))+
...
K_LNS<-ggplot()+geom_col(Leaching_LNS, mapping= aes(x="Leached", y=K, fill="Leached"))+
  geom_col(Net_Removal_LNS, mapping=aes(x="Harvested", y=K_F*.99+K_Bol*.97+K_Brh*.99+K_Brk*.9, fill="Harvested"))+
  scale_fill_manual(values=c("dark red", "orange"))+labs(x=NULL, y=NULL, title="Low N Sedimentary", fill="Legend")+
  theme_classic2()+theme(plot.title = element_text(hjust = 0.5))+
...
S_LNS<-ggplot()+geom_col(Leaching_LNS, mapping= aes(x="Leached", y=SO4, fill="Leached"))+
  geom_col(Net_Removal_LNS, mapping=aes(x="Harvested", y=S_F*.99+S_Bol*.97+S_Brh*.99+S_Brk*.9, fill="Harvested"))+
...
P_LNS<-ggplot()+geom_col(Leaching_LNS, mapping= aes(x="Leached", y=P, fill="Leached"))+
  geom_col(Net_Removal_LNS, mapping=aes(x="Harvested", y=P_F*.99+P_Bol*.97+P_Brh*.99+P_Brk*.9, fill="Harvested"))+
...
N_LNS<-ggplot()+geom_col(Leaching_LNS, mapping= aes(x="Leached", y=NO3+NH4, fill="Leached"))+
  geom_col(Net_Removal_LNS, mapping=aes(x="Harvested", y=N_F*.99+N_Bol*.97+N_Brh*.99+N_Brk*.9, fill="Harvested"))+
  scale_fill_manual(values=c(" dark red", "orange"))+labs(x=NULL, y=NULL, title="Low N Sedimentary", fill="Legend")+
  theme_classic2()+theme(plot.title = element_text(hjust = 0.5))+
...
Ca_HNS<-ggplot()+geom_col(Leaching_HNS, mapping= aes(x="Leached", y=Ca, fill="Leached"))+
  geom_col(Net_Removal_HNS, mapping=aes(x="Harvested", y=Ca_F*.99+Ca_Bol*.97+Ca_Brh*.99+Ca_Brk*.9, fill="Harvested"))+
...
Mg_HNS<-ggplot()+geom_col(Leaching_HNS, mapping= aes(x="Leached", y=Mg, fill="Leached"))+
  geom_col(Net_Removal_HNS, mapping=aes(x="Harvested", y=Mg_F*.99+Mg_Bol*.97+Mg_Brh*.99+Mg_Brk*.9, fill="Harvested"))+
...
K_HNS<-ggplot()+geom_col(Leaching_HNS, mapping= aes(x="Leached", y=K, fill="Leached"))+
  geom_col(Net_Removal_HNS, mapping=aes(x="Harvested", y=K_F*.99+K_Bol*.97+K_Brh*.99+K_Brk*.9, fill="Harvested"))+
  scale_fill_manual(values=c("dark red", "orange"))+labs(x=NULL, y=NULL, title="High N Sedimentary", fill="Legend")+
  theme_classic2()+theme(plot.title = element_text(hjust = 0.5))+
  scale_y_continuous(breaks=c(300, 600, 900, 1200, 1500, 1800))+
  coord_cartesian(ylim = c(0, 1800))
...
S_HNS<-ggplot()+geom_col(Leaching_HNS, mapping= aes(x="Leached", y=SO4, fill="Leached"))+
  geom_col(Net_Removal_HNS, mapping=aes(x="Harvested", y=S_F*.99+S_Bol*.97+S_Brh*.99+S_Brk*.9, fill="Harvested"))+
...
P_HNS<-ggplot()+geom_col(Leaching_HNS, mapping= aes(x="Leached", y=P, fill="Leached"))+
  geom_col(Net_Removal_HNS, mapping=aes(x="Harvested", y=P_F*.99+P_Bol*.97+P_Brh*.99+P_Brk*.9, fill="Harvested"))+
...
N_HNS<-ggplot()+geom_col(Leaching_HNS, mapping= aes(x="Leached", y=NO3+NH4, fill="Leached"))+
  geom_col(Net_Removal_HNS, mapping=aes(x="Harvested", y=N_F*.99+N_Bol*.97+N_Brh*.99+N_Brk*.9, fill="Harvested"))+
  scale_fill_manual(values=c(" dark red", "orange"))+labs(x=NULL, y=NULL, title="High N Sedimentary", fill="Legend")+
  theme_classic2()+theme(plot.title = element_text(hjust = 0.5))+
  scale_y_continuous(breaks=c(1500, 4500, 6000))+
  coord_cartesian(ylim = c(0, 6500))
...
Ca_LNB<-ggplot()+geom_col(Leaching_LNB, mapping= aes(x="Leached", y=Ca, fill="Leached"))+
  geom_col(Net_Removal_LNB, mapping=aes(x="Harvested", y=Ca_F*.99+Ca_Bol*.97+Ca_Brh*.99+Ca_Brk*.9, fill="Harvested"))+
...
Mg_LNB<-ggplot()+geom_col(Leaching_LNB, mapping= aes(x="Leached", y=Mg, fill="Leached"))+
  geom_col(Net_Removal_LNB, mapping=aes(x="Harvested", y=Mg_F*.99+Mg_Bol*.97+Mg_Brh*.99+Mg_Brk*.9, fill="Harvested"))+
...
K_LNB<-ggplot()+geom_col(Leaching_LNB, mapping= aes(x="Leached", y=K, fill="Leached"))+
  geom_col(Net_Removal_LNB, mapping=aes(x="Harvested", y=K_F*.99+K_Bol*.97+K_Brh*.99+K_Brk*.9, fill="Harvested"))+
  scale_fill_manual(values=c("dark red", "orange"))+labs(x=NULL, y=NULL, title="Low N Basalt", fill="Legend")+
  theme_classic2()+theme(plot.title = element_text(hjust = 0.5))+
  scale_y_continuous(breaks=c(300, 600, 900, 1200, 1500, 1800))+
  coord_cartesian(ylim = c(0, 1800))
...
S_LNB<-ggplot()+geom_col(Leaching_LNB, mapping= aes(x="Leached", y=SO4, fill="Leached"))+
  geom_col(Net_Removal_LNB, mapping=aes(x="Harvested", y=S_F*.99+S_Bol*.97+S_Brh*.99+S_Brk*.9, fill="Harvested"))+
...
P_LNB<-ggplot()+geom_col(Leaching_LNB, mapping= aes(x="Leached", y=P, fill="Leached"))+
  geom_col(Net_Removal_LNB, mapping=aes(x="Harvested", y=P_F*.99+P_Bol*.97+P_Brh*.99+P_Brk*.9, fill="Harvested"))+
...
N_LNB<-ggplot()+geom_col(Leaching_LNB, mapping= aes(x="Leached", y=NO3+NH4, fill="Leached"))+
  geom_col(Net_Removal_LNB, mapping=aes(x="Harvested", y=N_F*.99+N_Bol*.97+N_Brh*.99+N_Brk*.9, fill="Harvested"))+
  scale_fill_manual(values=c(" dark red", "orange"))+labs(x=NULL, y=NULL, title="Low N Basalt", fill="Legend")+
  theme_classic2()+theme(plot.title = element_text(hjust = 0.5))+
  scale_y_continuous(breaks=c(1500, 4500, 6000))+
  coord_cartesian(ylim = c(0, 6500))
...
Ca_HNB<-ggplot()+geom_col(Leaching_HNB, mapping= aes(x="Leached", y=Ca, fill="Leached"))+
  geom_col(Net_Removal_HNB, mapping=aes(x="Harvested", y=Ca_F*.99+Ca_Bol*.97+Ca_Brh*.99+Ca_Brk*.9, fill="Harvested"))+
...
Mg_HNB<-ggplot()+geom_col(Leaching_HNB, mapping= aes(x="Leached", y=Mg, fill="Leached"))+
  geom_col(Net_Removal_HNB, mapping=aes(x="Harvested", y=Mg_F*.99+Mg_Bol*.97+Mg_Brh*.99+Mg_Brk*.9, fill="Harvested"))+
...
K_HNB<-ggplot()+geom_col(Leaching_HNB, mapping= aes(x="Leached", y=K, fill="Leached"))+
  geom_col(Net_Removal_HNB, mapping=aes(x="Harvested", y=K_F*.99+K_Bol*.97+K_Brh*.99+K_Brk*.9, fill="Harvested"))+
  scale_fill_manual(values=c("dark red", "orange"))+labs(x=NULL, y=NULL, title="High N Basalt", fill="Legend")+
  theme_classic2()+theme(plot.title = element_text(hjust = 0.5))+
  scale_y_continuous(breaks=c(300, 600, 900, 1200, 1500, 1800))+
  coord_cartesian(ylim = c(0, 1800))
...
S_HNB<-ggplot()+geom_col(Leaching_HNB, mapping= aes(x="Leached", y=SO4, fill="Leached"))+
  geom_col(Net_Removal_HNB, mapping=aes(x="Harvested", y=S_F*.99+S_Bol*.97+S_Brh*.99+S_Brk*.9, fill="Harvested"))+
...
P_HNB<-ggplot()+geom_col(Leaching_HNB, mapping= aes(x="Leached", y=P, fill="Leached"))+
  geom_col(Net_Removal_HNB, mapping=aes(x="Harvested", y=P_F*.99+P_Bol*.97+P_Brh*.99+P_Brk*.9, fill="Harvested"))+
...
N_HNB<-ggplot()+geom_col(Leaching_HNB, mapping= aes(x="Leached", y=NO3+NH4, fill="Leached"))+
  geom_col(Net_Removal_HNB, mapping=aes(x="Harvested", y=N_F*.99+N_Bol*.97+N_Brh*.99+N_Brk*.9, fill="Harvested"))+
  scale_fill_manual(values=c(" dark red", "orange"))+labs(x=NULL, y=NULL, title="High N Basalt", fill="Legend")+
  theme_classic2()+theme(plot.title = element_text(hjust = 0.5))+
  scale_y_continuous(breaks=c(1500, 4500, 6000))+
  coord_cartesian(ylim = c(0, 6500))
...
ggarrange(Ca_LNS, Ca_HNS, Ca_LNB, Ca_HNB, labels=c("A", "B", "C", "D"),
  ...
  annotate_figure(left = textGrob(expression("Ca Loss ( kg"~'⋅'~ha^{-1}~')'), rot = 90, vjust=.45, gp = gpar(cex = 1.3,
                  ...
                  bottom = textGrob("Loss Type", gp = gpar(cex = 1.3)), top=textGrob("40 WTH")) %>%
