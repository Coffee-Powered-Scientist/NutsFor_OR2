...
# Compares Uptake Lim. Line Graphs to one another, this file is for 40_WTH case
rm(list = ls())
...
source("~/Project_Master/Test_Rep/Code/HN_BAS/40_WTH/Plant_Pool_Ghost.R")
source("~/Project_Master/Test_Rep/Code/LN_BAS/40_WTH/Plant_Pool_Ghost.R")
source("~/Project_Master/Test_Rep/Code/HN_SED/40_WTH/Plant_Pool_Ghost.R")
source("~/Project_Master/Test_Rep/Code/LN_SED/40_WTH/Plant_Pool_Ghost.R")

# HN BAS File Reading

Plant_Pool_HNBAS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_WTH/Edited Data/Plant_Pool.csv")
Plant_Pool_HNBAS_Ghost<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_WTH/Edited Data/Plant_Pool_Ghost.csv")
Plant_Pool_HNBAS$ID<-"HNBAS"

Above_FluxGHOST_HNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_WTH/Edited Data/Abov_Flux_Ghost.csv")
Above_Flux_HNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_WTH/Edited Data/Abov_Flux.csv")
...
Plant_Pool_LNBAS_Ghost<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_WTH/Edited Data/Plant_Pool_Ghost.csv")
Plant_Pool_LNBAS$ID<-"LNBAS"

Above_FluxGHOST_LNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_WTH/Edited Data/Abov_Flux_Ghost.csv")
Above_Flux_LNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_WTH/Edited Data/Abov_Flux.csv")
...
Plant_Pool_HNSED_Ghost<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Edited Data/Plant_Pool_Ghost.csv")
Plant_Pool_HNSED$ID<-"HNSED"

Above_FluxGHOST_HNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Edited Data/Abov_Flux_Ghost.csv")
Above_Flux_HNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Edited Data/Abov_Flux.csv")
...
Plant_Pool_LNSED_Ghost<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_WTH/Edited Data/Plant_Pool_Ghost.csv")
Plant_Pool_LNSED$ID<-"LNSED"

Above_FluxGHOST_LNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_WTH/Edited Data/Abov_Flux_Ghost.csv")
Above_Flux_LNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_WTH/Edited Data/Abov_Flux.csv")
