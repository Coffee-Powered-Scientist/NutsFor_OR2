...
PP_LNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_SED/40_WTH/Edited Data/Plant_Pool.csv")
...
label_color_Ca<-c( "Exchangeable","Organic" , "Plant")
label_color_Mg<-c("Exchangeable","Organic" , "Plant")
label_color_K<-c( "Exchangeable","Organic" , "Plant")
label_color_N<-c("Organic" , "Plant")
label_color_S<-c( "Adsorbed","Organic" , "Plant")
label_color_P<-c( "Adsorbed","Organic" , "Plant")
...
PP_HNS<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Edited Data/Plant_Pool.csv")
...
PP_LNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_WTH/Edited Data/Plant_Pool.csv")
...
PP_HNB<-read.csv2("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_WTH/Edited Data/Plant_Pool.csv")
