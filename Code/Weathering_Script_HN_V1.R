...
setwd("~/Project_Master/Test_Rep/Output_HN_SED/Weathering")
library(ggplot2)
library(dplyr)
library(scales)
Nuts_For_Weathering1<-read.csv("~/NutsForSEDHN/Output data/Weathering/Weathering Layer 1.csv", sep=";", header=FALSE)
