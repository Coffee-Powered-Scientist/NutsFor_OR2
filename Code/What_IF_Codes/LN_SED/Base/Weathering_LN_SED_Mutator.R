...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/LN_SED/Base/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforSEDLN/Base/Output data/Weathering", pattern = "Layer", full.names = TRUE)
