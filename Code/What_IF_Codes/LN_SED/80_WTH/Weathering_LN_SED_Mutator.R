...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/LN_SED/80_WTH/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforSEDLN/80_WTH/Output data/Weathering", pattern = "Layer", full.names = TRUE)
