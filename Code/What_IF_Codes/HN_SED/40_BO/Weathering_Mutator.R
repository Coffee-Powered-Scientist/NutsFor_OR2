...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/HN_SED/40_BO/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforSEDHN/40_BO/Output data/Weathering", pattern = "Layer", full.names = TRUE)
