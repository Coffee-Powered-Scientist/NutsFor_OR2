...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/HN_SED/40_WTH/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforSEDHN/40_WTH/Output data/Weathering", pattern = "Layer", full.names = TRUE)
