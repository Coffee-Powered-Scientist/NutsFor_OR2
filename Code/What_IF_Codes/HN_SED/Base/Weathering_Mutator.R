...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/HN_SED/Base/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforSEDHN/Base/Output data/Weathering", pattern = "Layer", full.names = TRUE)
