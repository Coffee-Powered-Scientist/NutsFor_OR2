...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/HN_BAS/80_BO/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforBASHN/80_BO/Output data/Weathering", pattern = "Layer", full.names = TRUE)
