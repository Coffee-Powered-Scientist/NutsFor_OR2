...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/HN_BAS/Base/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforBASHN/Base/Output data/Weathering", pattern = "Layer", full.names = TRUE)
