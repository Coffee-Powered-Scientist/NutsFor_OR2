...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/HN_BAS/80_WTH/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforBASHN/80_WTH/Output data/Weathering", pattern = "Layer", full.names = TRUE)
