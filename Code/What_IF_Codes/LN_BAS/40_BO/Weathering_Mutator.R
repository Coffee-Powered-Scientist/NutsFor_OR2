...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/LN_BAS/40_BO/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforBASLN/40_BO/Output data/Weathering", pattern = "Layer", full.names = TRUE)
