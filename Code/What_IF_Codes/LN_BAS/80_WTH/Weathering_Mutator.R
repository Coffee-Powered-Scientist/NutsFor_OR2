...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/LN_BAS/80_WTH/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforBASLN/80_WTH/Output data/Weathering", pattern = "Layer", full.names = TRUE)
