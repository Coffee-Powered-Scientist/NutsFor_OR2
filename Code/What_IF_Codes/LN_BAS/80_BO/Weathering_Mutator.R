...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/LN_BAS/80_BO/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforBASLN/80_BO/Output data/Weathering", pattern = "Layer", full.names = TRUE)
