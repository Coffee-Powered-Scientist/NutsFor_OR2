...
setwd("~/Project_Master/Test_Rep/Output/WhatIF/LN_BAS/Base/Edited Data")
...
files <- list.files(path = "~/WHATIF/NutsforBASLN/Base/Output data/Weathering", pattern = "Layer", full.names = TRUE)
