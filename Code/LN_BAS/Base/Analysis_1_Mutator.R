...
setwd("~/Project_Master/Test_Rep/Output/Calibration/Output_LN_BAS/Base/Edited Data")



Above_Flux<-read.csv2("~/NutsForBASLN/Base/Output data/Budgets/Above ground fluxes.csv", header=FALSE)
Bio_Flux<-read.csv2("~/NutsForBASLN/Base/Output data/Budgets/Biological cycle.csv",header=FALSE)
