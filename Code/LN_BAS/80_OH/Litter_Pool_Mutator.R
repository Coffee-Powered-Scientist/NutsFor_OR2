...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/80_OH/Edited Data")

#Can't use above ground flux file, wrong time-step!
source("~/Project_Master/Test_Rep/Code/Functions/Conversion_Func.R")


Litter_Pool<-read.csv2("~/NutsForBASLN/80_OH/Output data/Litter/Litter pool kg_ha data.csv")
Litter_Amount<-read.csv2("~/NutsForBASLN/80_OH/Output data/Litter/Litterfall.csv",header=FALSE)
