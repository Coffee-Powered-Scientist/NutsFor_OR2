...
Above_Flux<-read.csv2("~/NutsForBASLN/80_BO/Output data/Budgets/Above ground fluxes.csv", header=FALSE)
Bio_Flux<-read.csv2("~/NutsForBASLN/80_BO/Output data/Budgets/Biological cycle.csv",header=FALSE)
