...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/80_WTH/Edited Data")



Above_Flux<-read.csv2("~/NutsForBASLN/80_WTH/Output data/Budgets/Above ground fluxes.csv", header=FALSE)
Bio_Flux<-read.csv2("~/NutsForBASLN/80_WTH/Output data/Budgets/Biological cycle.csv",header=FALSE)
