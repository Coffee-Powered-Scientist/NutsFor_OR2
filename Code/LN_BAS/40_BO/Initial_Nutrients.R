...
Files<- list.files("C:/Users/siahl/OneDrive - Oregon State University/Documents/NutsForBASLN/40_BO/Output data/SOM",
...
files <- list.files(path = "~/NutsforBASLN/40_BO/Output data/CEC", pattern = "CEC", full.names = TRUE)
...
AEC_Files <- list.files(path = "~/NutsforBASLN/40_BO/Output data/AEC", pattern = "AEC", full.names = TRUE)
...
Litter<-read.csv2("~/NutsforBASLN/40_BO/Output data/Litter/Litter pool kg_ha data.csv")
