...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_WTH/Sens/Ex/Lower")
...
files <- list.files(path = "~/Sens_Parent/Sens_Exch/LN_BAS/40_WTH/Minimum/Output data/Soil solution", pattern = "*.csv", full.names = TRUE)
