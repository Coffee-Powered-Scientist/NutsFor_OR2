...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_BO/Sens/SOMP/Upper")
...
files <- list.files(path = "~/Sens_Parent/Sens_SOMP/LN_BAS/Maximum/Output data/Soil solution", pattern = "*.csv", full.names = TRUE)
