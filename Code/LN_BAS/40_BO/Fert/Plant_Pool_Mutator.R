...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/LN_BAS/40_BO/Fert Data")


source("~/Project_Master/Test_Rep/Code/Functions/Uptake_Diff.R")

Plant_Pool<-read.csv2("~/NutsForBASLN/Fertilized/Output data/Biomass/Plant pool.csv", header=FALSE)
