...
setwd("~/Project_Master/Test_Rep/Output/Calibration/Output_LN_BAS/Sens/Min/Upper")
...
files <- list.files(path = "~/Sens_Parent/Sens_Min/LN_BAS/Base/Maximum/Output data/Soil solution", pattern = "*.csv", full.names = TRUE)
