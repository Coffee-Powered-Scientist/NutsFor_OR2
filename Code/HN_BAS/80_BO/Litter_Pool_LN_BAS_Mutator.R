...
Litter_Pool<-read.csv2("~/NutsForBASLN/80_BO/Output data/Litter/Litter pool kg_ha data.csv")
Litter_Amount<-read.csv2("~/NutsForBASLN/80_BO/Output data/Litter/Litterfall.csv",header=FALSE)
