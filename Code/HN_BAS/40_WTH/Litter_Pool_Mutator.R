...
Litter_Pool<-read.csv2("~/NutsForBASHN/40_WTH/Output data/Litter/Litter pool kg_ha data.csv")
Litter_Amount<-read.csv2("~/NutsForBASHN/40_WTH/Output data/Litter/Litterfall.csv",header=FALSE)
