...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/80_WTH/Edited Data")


Above_Flux<-read.csv2("~/NutsForBASHN/80_WTH/Output data/Budgets/Above ground fluxes.csv", header=FALSE)
Bio_Flux<-read.csv2("~/NutsForBASHN/80_WTH/Output data/Budgets/Biological cycle.csv",header=FALSE)
