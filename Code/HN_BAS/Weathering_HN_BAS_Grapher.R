...
setwd("~/Project_Master/Test_Rep/Output_HN_BAS/Weathering")

library(ggplot2)

Weathering_All<-read.csv2("~/Project_Master/Test_Rep/Output_HN_BAS/Edited Data/Weathering_All.csv", header=TRUE)
