...
setwd("~/Project_Master/Test_Rep/Output/Calibration/Output_LN_SED/Sens/Nit/Lower")
...
files <- list.files(path = "~/Sens_Parent/Sens_Nit/LN_SED/Base/Minimum/Output data/Soil solution", pattern = "*.csv", full.names = TRUE)
