...
library(dplyr)
Nuts_For_Weathering1<-read.csv2("~/NutsForBASHN/Output data/Weathering/Weathering Layer 1.csv", header=FALSE)
...
Nuts_For_Weathering2<-read.csv("~/NutsForBASHN/Output data/Weathering/Weathering Layer 2.csv", sep=";", header=FALSE)
...
Nuts_For_Weathering3<-read.csv("~/NutsForBASHN/Output data/Weathering/Weathering Layer 3.csv", sep=";", header=FALSE)
...
Nuts_For_Weathering4<-read.csv("~/NutsForBASHN/Output data/Weathering/Weathering Layer 4.csv", sep=";", header=FALSE)
...
Nuts_For_Weathering5<-read.csv("~/NutsForBASHN/Output data/Weathering/Weathering Layer 5.csv", sep=";", header=FALSE)
...
Nuts_For_Weathering6<-read.csv("~/NutsForBASHN/Output data/Weathering/Weathering Layer 6.csv", sep=";", header=FALSE)
...
Nuts_For_Weathering7<-read.csv("~/NutsForBASHN/Output data/Weathering/Weathering Layer 7.csv", sep=";", header=FALSE)
...
Nuts_For_Weathering8<-read.csv("~/NutsForBASHN/Output data/Weathering/Weathering Layer 8.csv", sep=";", header=FALSE)
