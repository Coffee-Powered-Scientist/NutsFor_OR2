...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/HN_BAS/40_BO/Sens/Nit/Lower")
...
files <- list.files(path = "~/Sens_Parent/Sens_Nit/HN_BAS/40_BO/Minimum/Output data/Soil solution", pattern = "*.csv", full.names = TRUE)
