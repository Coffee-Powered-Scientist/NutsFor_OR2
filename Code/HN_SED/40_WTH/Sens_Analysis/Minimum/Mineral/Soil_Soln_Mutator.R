...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Sens/Min/Lower")
...
files <- list.files(path = "~/Sens_Parent/Sens_Min/HN_SED/40_WTH/Minimum/Output data/Soil solution", pattern = "*.csv", full.names = TRUE)
