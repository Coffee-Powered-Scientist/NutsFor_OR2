...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_WTH/Sens/Ex/Upper")
...
files <- list.files(path = "~/Sens_Parent/Sens_Exch/HN_SED/40_WTH/Maximum/Output data/Soil solution", pattern = "*.csv", full.names = TRUE)
