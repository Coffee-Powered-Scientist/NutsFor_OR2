...
setwd("~/Project_Master/Test_Rep/Output/Manuscript/HN_SED/40_BO/Fert Data")


source("~/Project_Master/Test_Rep/Code/Functions/Uptake_Diff.R")

Plant_Pool<-read.csv2("~/NutsForSEDHN/Fertilized/Output data/Biomass/Plant pool.csv", header=FALSE)
