...
Tree_Nut<-read.csv2("~/Ghost_Simulations/NutsForSEDHN/40_BO/Output data/Biomass/Tree data.csv", header=FALSE)
...
write.csv2(Tree_Nutrients_All, "Tree_Nut_AllGHOST.csv")
